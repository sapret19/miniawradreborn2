...
class Burdah3 extends StatefulWidget {
  const Burdah3({super.key, required double fontSize});

  @override
  State<Burdah3> createState() => _Burdah3State();
}

class _Burdah3State extends State<Burdah3> {
  Future<List<ModelJson>> ReadJsonData() async {
    final JsonData =
        await rootBundle.rootBundle.loadString('assets/json/burdah3.json');
